import type { CourseStatusSelector } from '@/platform/components/CourseBuilder/CourseStatusSelector'
...
export const courseStatusSelectorMeta: GalleryComponentMeta = {
  ...
  sourceId: '@/platform/components/CourseBuilder/CourseStatusSelector#CourseStatusSelector',
  status: 'prod',
}
