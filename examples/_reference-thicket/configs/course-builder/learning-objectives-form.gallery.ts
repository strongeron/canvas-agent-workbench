import type { LearningObjectivesForm } from "@/platform/components/CourseBuilder/LearningObjectivesForm"
...
const learningObjectivesFormMeta: GalleryComponentMeta = {
  ...
  sourceId: "@/platform/components/CourseBuilder/LearningObjectivesForm#LearningObjectivesForm",
  status: 'prod',
}

export const learningObjectivesFormGalleryEntry: GalleryEntry<LearningObjectivesFormProps> = {
  name: 'LearningObjectivesForm',
  importPath: '@/platform/components/CourseBuilder/LearningObjectivesForm',
