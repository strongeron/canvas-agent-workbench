import { UnpublishCourseModal, type UnpublishCourseModalProps } from '@/platform/components/CourseBuilder/UnpublishCourseModal'
...
const unpublishCourseModalMeta: GalleryComponentMeta = {
  ...
  sourceId: "@/platform/components/CourseBuilder/UnpublishCourseModal#UnpublishCourseModal",
  status: 'prod',
}

export const unpublishCourseModalGalleryEntry: GalleryEntry<UnpublishCourseModalProps> = {
  name: 'UnpublishCourseModal',
  importPath: '@/platform/components/CourseBuilder/UnpublishCourseModal',
