import type { AssignmentUploadZone } from "@/platform/components/CourseBuilder/AssignmentUploadZone"
...
const assignmentUploadZoneMeta: GalleryComponentMeta = {
  ...
  sourceId: '@/platform/components/CourseBuilder/AssignmentUploadZone#AssignmentUploadZone',
  status: 'archive',
}
