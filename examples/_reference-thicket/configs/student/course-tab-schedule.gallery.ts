import type { CourseTabScheduleProps } from '@/platform/components/Student/CourseTabSchedule'
...
export const courseTabScheduleMeta: GalleryComponentMeta = {
  ...
  sourceId: '@/platform/components/Student/CourseTabSchedule#CourseTabSchedule',
  status: 'prod',
}
