import { StudentMessageComposerModal, type StudentMessageComposerModalProps } from '@/platform/components/Messages/StudentMessageComposerModal'
...
export const studentMessageComposerModalMeta: GalleryComponentMeta = {
  ...
  sourceId: '@/platform/components/Messages/StudentMessageComposerModal#StudentMessageComposerModal',
  status: 'prod',
}
