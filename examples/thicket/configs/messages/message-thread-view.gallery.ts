import type { MessageThreadViewProps } from '@/platform/components/Messages/MessageThreadView'

import { GALLERY_MESSAGE_THREADS } from '../mocks/galleryData'
import type { GalleryComponentMeta } from '../registry/types'
import type { GalleryEntry } from '../registry/types'

export const messageThreadViewMeta: GalleryComponentMeta = {
  id: 'messages/message-thread-view',
  sourceId: '@/platform/components/Messages/MessageThreadView#MessageThreadView',
  status: 'prod',
}
