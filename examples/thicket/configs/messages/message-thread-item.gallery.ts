...
import type { MessageThreadItem } from '@/platform/components/Messages/MessageThreadItem'
import {
...
const messageThreadItemMeta: GalleryComponentMeta = {
  ...
  sourceId: '@/platform/components/Messages/MessageThreadItem#MessageThreadItem',
  status: 'archive',
}
