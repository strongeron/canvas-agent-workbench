import type { CourseTabMessageBoardProps } from '@/platform/components/Student/CourseTabMessageBoard'
...
const courseTabMessageBoardMeta: GalleryComponentMeta = {
  ...
  sourceId: '@/platform/components/Student/CourseTabMessageBoard#CourseTabMessageBoardProps',
  status: 'archive',
}
