import type { CourseTabFilesProps } from '@/platform/components/Student/CourseTabFiles'
...
const courseTabFilesMeta: GalleryComponentMeta = {
  ...
  sourceId: '@/platform/components/Student/CourseTabFiles#CourseTabFilesProps',
  status: 'archive',
}
