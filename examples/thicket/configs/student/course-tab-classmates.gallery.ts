// @ts-nocheck
import type { CourseTabClassmatesProps } from '@/platform/components/Student/CourseTabClassmates'

import { GALLERY_COURSES, GALLERY_INSTRUCTORS, GALLERY_STUDENTS } from '../mocks/galleryData'
import type { GalleryComponentMeta } from '../registry/types'
import type { GalleryEntry } from '../registry/types'

export const courseTabClassmatesMeta: GalleryComponentMeta = {
  id: 'student/course-tab-classmates',
  sourceId: '@/platform/components/Student/CourseTabClassmates#CourseTabClassmates',
  status: 'prod',
}
