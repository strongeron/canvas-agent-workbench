import { RescheduleModal, type RescheduleModalProps } from '@/platform/components/Teacher/RescheduleModal'
...
const rescheduleModalMeta: GalleryComponentMeta = {
  ...
  sourceId: '@/platform/components/Teacher/RescheduleModal#RescheduleModalProps',
  status: 'archive',
}
