...
// Archived/Deprecated Components (kept for learning and reference)
import {
  filterButtonGalleryEntry,
  legacyCourseFilterGalleryEntry,
  legacyStudentActivityFilterGalleryEntry,
  legacyToastGalleryEntry,
} from './configs/_archive'
...
// Archived/Deprecated Components (kept for learning and reference)
// These show evolution of the design system - what we moved away from and why
export const archivedComponents: ComponentEntry[] = [
  filterButtonGalleryEntry,
  legacyCourseFilterGalleryEntry,
  legacyStudentActivityFilterGalleryEntry,
  legacyToastGalleryEntry,
...
export const componentsByCategory: Record<string, ComponentEntry[]> = {
  ...
  'Archived (Deprecated)': archivedComponents,
}
