...
interface CanvasLayoutMermaidItemProps {
  item: CanvasMermaidItemType
  isSelected: boolean
  onSelect: (addToSelection?: boolean) => void
  onUpdate: (updates: Partial<Omit<CanvasMermaidItemType, "id">>) => void
  scale: number
...
export function CanvasLayoutMermaidItem({
  item,
  isSelected,
  onSelect,
  onUpdate,
