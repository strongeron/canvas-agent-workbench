...
export const AGENT_NATIVE_WORKSPACE_DEFINITIONS: AgentWorkspaceDefinition[] = [
  {
    ...
    tools: [
      ...
      },
      {
        ...
        description: "Read the append-only event log for the current Canvas workspace. Cursor-paged: pass sinceCursor to fetch only newer events, poll again with the returned nextCursor. Event kinds: user-action, source-edit, operation-queued, operation-applied, state-synced.",
        status: "ready",
      },
      {
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        id: "get_workspace_events",
        title: "Get workspace events",
        description: "Read the append-only event log for the current Color Audit workspace. Cursor-paged: pass sinceCursor to fetch only newer events, poll again with the returned nextCursor. Event kinds: user-action, source-edit, operation-queued, operation-applied, state-synced.",
        status: "ready",
      },
      {
        id: "get_workspace_debug",
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        id: "get_workspace_events",
        title: "Get workspace events",
        description: "Read the append-only event log for the current System Canvas workspace. Cursor-paged: pass sinceCursor to fetch only newer events, poll again with the returned nextCursor. Event kinds: user-action, source-edit, operation-queued, operation-applied, state-synced.",
        status: "ready",
      },
      {
        id: "get_workspace_debug",
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        id: "get_workspace_events",
        title: "Get workspace events",
        description: "Read the append-only event log for the current Node Catalog surface. Cursor-paged: pass sinceCursor to fetch only newer events, poll again with the returned nextCursor. Event kinds: user-action, source-edit, operation-queued, operation-applied, state-synced.",
        status: "ready",
      },
      {
        id: "get_workspace_debug",
